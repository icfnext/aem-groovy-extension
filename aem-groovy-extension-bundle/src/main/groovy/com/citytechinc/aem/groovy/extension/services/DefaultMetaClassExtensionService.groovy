...
class DefaultMetaClassExtensionService implements MetaClassExtensionService {
	...
	static def BINARY_METACLASS_EXTENSION_CLOSURE = {
	...
	static def NODE_METACLASS_EXTENSION_CLOSURE = {
		iterator { delegate.nodes }
	...
	static def PAGE_METACLASS_EXTENSION_CLOSURE = {
		iterator { delegate.listChildren() }
	...
	static def SCRIPT_METACLASS_EXTENSION_CLOSURE = {
		getNode = { String path ->
		...
		getServices = { String className, String filter ->
		...
		doWhileDisabled = { String componentClassName, Closure closure ->
	...
	Map<Class, Closure[]> getMetaClassExtensions() {
		return [(Binary.class) : [BINARY_METACLASS_EXTENSION_CLOSURE],
			(Node.class) : [NODE_METACLASS_EXTENSION_CLOSURE],
			(Page.class) : [PAGE_METACLASS_EXTENSION_CLOSURE],
			(Script.class) : [SCRIPT_METACLASS_EXTENSION_CLOSURE]]
	}
}
